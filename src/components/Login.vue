        ...
        <div class="flex flex-col space-y-10">
          ...
          <form class="w-full">
            <div class="relative mb-5">
              ...
              <input v-model="email" type="email" id="email" class="pl-12 bg-gray-50 border border-gray-300 text-gray-900 text-base rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Email" required />
            </div>
            <div class="relative mb-5">
              <div class="absolute -translate-y-1/2 top-1/2 left-4">
                <svg class="text-gray-500 size-6" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
