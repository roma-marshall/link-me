      ...
      <div class="flex flex-col justify-around h-screen mx-10">
        ...
        <div class="flex flex-col space-y-10">
          ...
          <form class="max-w-sm mx-auto w-full">
            ...
            <button @click="logIn" type="submit" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Log In</button>
          </form>
        </div>
