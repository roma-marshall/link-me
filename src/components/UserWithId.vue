<template>
  <div>
    ...
    <div class="flex flex-col justify-center mx-5">
      <div class="flex">
        <div v-if="auth?.currentUser?.uid === uid" class="flex ml-0 mr-auto p-3 border border-gray-300 bg-gray-100 rounded-full w-fit">
        ...
        <div class="flex ml-auto mr-0 p-3 border border-gray-300 bg-gray-100 rounded-full w-fit">
          <svg class="w-5 h-5" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
      ...
      <div class="flex flex-col items-center text-center mx-auto">
        <div class="flex space-x-2">
          ...
          <svg v-if="auth?.currentUser?.uid === uid" class="w-5 h-5 my-auto" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
