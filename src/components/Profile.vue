  ...
  <div>
    <div class="flex flex-col justify-center mx-5 my-10">
      ...
      <div class="flex flex-col items-center text-center space-y-5">
        ...
        <!-- Save data -->
        <a @click="saveUserData" class="cursor-pointer text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
          Save
        </a>
